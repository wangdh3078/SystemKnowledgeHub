...
import { Coin, Connection, QuestionFilled, WarningFilled } from '@element-plus/icons-vue'
  ...
  <div class="system-context-rail">
    ...
    <section class="system-rail-section">
      <div class="system-rail-section__title">
        <h3>
          <el-icon><Connection /></el-icon>关联系统
        </h3>
    ...
    <section class="system-rail-section">
      <div class="system-rail-section__title">
        <h3>
          <el-icon><Connection /></el-icon>集成概况
        </h3>
        <span>{{ context.integrationCount }}</span>
      </div>
      <p class="system-rail-empty">
        {{ context.integrationCount ? '查看系统级集成摘要。' : '暂无集成关系记录。' }}
      </p>
    </section>
    ...
    <section class="system-rail-section">
      <div class="system-rail-section__title">
        <h3>
          <el-icon><QuestionFilled /></el-icon>高优先级待确认事项
        </h3>
    ...
    <section class="system-rail-section">
      <div class="system-rail-section__title">
        <h3>
          <el-icon><WarningFilled /></el-icon>知识缺口
        </h3>
    ...
    <p class="system-context-rail__note">业务功能、数据库对象与集成的完整内容保留在主内容区。</p>
  </div>
</template>
