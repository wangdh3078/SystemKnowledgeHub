...
public sealed record SoftDeleteActorApiResolution(
...
{
    public static async Task<SoftDeleteActorApiResolution> ResolveSoftDeleteActor(
        ...
        CancellationToken cancellationToken)
    {
        ...
        var failure = ResolveFailure(resolution.Status);
        return new SoftDeleteActorApiResolution(null, failure.StatusCode, failure.Error);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ResolveFailure(resolution.Status);
    }

    private static CanonicalCreatorApiResolution ResolveFailure(CurrentUserResolutionStatus status) => status switch
    {
